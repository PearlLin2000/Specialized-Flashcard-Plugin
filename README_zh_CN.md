...
**专项复习**：基于自定义 SQL 查询，灵活检索符合条件的闪卡，实现针对性复习。
...
@[TCOTC](https://github.com/TCOTC)(J 佬)：思源爱好者之神！为我进行了细致的审核和修改说明，还有很多我没搞明白的杂项文件说明。中文使用者应该感谢 J 佬，他为你们规避了诸多 bug、message 弹窗和 console.log。非中文使用者更加应该感谢 J 佬，除中文使用者的获得外，他还额外让你们“看见”这个插件。
